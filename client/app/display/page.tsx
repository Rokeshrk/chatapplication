// pages/index.tsx
"use client"
import ContactList from '../../components/componen/ChatList';
import ChatBox from '../../components/componen/ChatBox';
import GroupList from '../../components/componen/GroupList';
import ChatBoxNavbar from '../../components/componen/ChatBoxNavbar';
            ...
            >
              <button>
                <div className="flex gap-2">
                  ...
                  <p className='ml-5 p-2 text-lg font-semibold'>
                    {groupData.groupName}
                  </p>
                </div>
              </button>
